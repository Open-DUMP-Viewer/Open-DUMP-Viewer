...
### このリポジトリについて — Why is the source public?

本ソースコードは **OSS ではありません** が、以下の目的で公開しています:

- **透明性** — セキュリティ・動作検証ができるように
- **知識継承** — 開発者 (YANAI Taketo) が継続できなくなった場合の保険として ([EULA §6](EULA.md) の自動ライセンス変更条項を参照)

公開コードをもとに独自ソフトを開発することは意図していません。詳細は [EULA](EULA.md) 冒頭の「本ソースコード公開の趣旨について」をご参照ください。
