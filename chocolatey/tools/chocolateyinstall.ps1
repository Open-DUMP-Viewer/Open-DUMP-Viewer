...
$url_x64   = "https://github.com/OraDB-DUMP-Viewer/OraDB-DUMP-Viewer/releases/download/v${version}/OraDBDumpViewer_v${version}_installer_x64.exe"
$url_arm64 = "https://github.com/OraDB-DUMP-Viewer/OraDB-DUMP-Viewer/releases/download/v${version}/OraDBDumpViewer_v${version}_installer_arm64.exe"
